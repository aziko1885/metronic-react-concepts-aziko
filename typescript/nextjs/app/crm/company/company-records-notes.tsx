...
const notes = [
  ...
  },
  {
    ...
    content: 'The onboarding process was smooth but could use more tooltips for new users.',
            ...
            <CardContent className='flex flex-col justify-between'>
              <div className='mb-2'>
                <div className="flex items-center gap-2 mb-2">
                  ...
                  />
                  <Link href="#" className="font-semibold text-xs hover:text-primary">
                    {note.org}
                  </Link>
                </div>
              ...
              <div className="flex items-center justify-between gap-1 mt-auto pt-2 text-xs text-muted-foreground">
                <div className="flex items-center gap-1">
                  ...
                  <Link href="#" className="font-medium text-mono text-xs hover:text-primary">
                    {note.author}
                  </Link> 
                </div>
