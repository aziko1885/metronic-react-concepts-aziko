...
export const CONNECTION_STRENGTHS = [
  ...
  },
  {
    id: '2',
    name: 'Medium',
    color: 'bg-yellow-500 text-yellow-900 dark:bg-yellow-500 dark:text-yellow-100'
  },
  {
    id: '3',
    name: 'Strong',
  ...
  },
  {
    ...
    color: 'bg-purple-500 text-purple-900 dark:bg-purple-500 dark:text-purple-100'
  }
];
