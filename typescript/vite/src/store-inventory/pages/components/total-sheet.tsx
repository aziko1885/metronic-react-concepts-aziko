...
const Inventory = ({}: InventoryProps) => {
  const items: InventoryItems = [
    { badgeColor: 'bg-green-500 size-2', label: 'In stock', total: 1892 },
    { badgeColor: 'bg-yellow-500 size-2', label: 'Low stock', total: 164 },
    { badgeColor: 'bg-destructive size-2', label: 'Out of stock', total: 257 },
  ];
    ...
    return (
      <div key={index} className="flex items-center gap-1.5">
        ...
        <span className="text-sm font-normal text-foreground">
          {item.label}:
          <span className="text-sm font-semibold text-dark ms-1">{item.total}</span>
        </span>
      </div>
    );
  };
    ...
    <Card>
      <CardContent className="flex gap-2 lg:gap-6 p-5 lg:p-7.5">
        <div className="flex flex-col gap-2">
          ...
          <span className="text-3xl font-semibold text-dark">$106,576.00</span>
        </div>
        ...
        <div className="flex flex-col gap-2 w-full">
          <div className="flex items-center gap-2 mb-2 -mt-1">
            <span className="text-xl font-semibold text-dark leading-0">2258</span> 
